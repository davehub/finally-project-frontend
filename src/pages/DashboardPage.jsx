    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg">
          <h2 className="text-2xl font-bold mb-4 text-gray-800">Incidents Récents</h2>
          <ul>
            <li className="flex justify-between items-center py-2 border-b border-gray-200 last:border-b-0">
              ...
              <span className="text-sm text-yellow-600 font-semibold">En cours</span>
            </li>
            <li className="flex justify-between items-center py-2 border-b border-gray-200 last:border-b-0">
              <span className="text-gray-700">Écran noir sur PC de bureau</span>
              <span className="text-sm text-yellow-600 font-semibold">En cours</span>
            </li>
            <li className="flex justify-between items-center py-2 border-b border-gray-200 last:border-b-0">
              <span className="text-gray-700">Impossible d'imprimer (imprimante RDC)</span>
              <span className="text-sm text-green-600 font-semibold">Résolu</span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg">
          <h2 className="text-2xl font-bold mb-4 text-gray-800">Activité Récente</h2>
          <ul>
            <li className="py-2 border-b border-gray-200 last:border-b-0">
              <span className="font-semibold">Alice Dupont</span> a ajouté un nouveau laptop.
              <span className="block text-xs text-gray-500">il y a 2 heures</span>
            </li>
            <li className="py-2 border-b border-gray-200 last:border-b-0">
              Mise à jour du logiciel "Microsoft Office" effectuée.
              <span className="block text-xs text-gray-500">il y a 1 jour</span>
            </li>
            <li className="py-2 border-b border-gray-200 last:border-b-0">
              <span className="font-semibold">Bob Martin</span> a signalé un incident.
              <span className="block text-xs text-gray-500">il y a 3 jours</span>
            </li>
          </ul>
        </div>
      </div>
